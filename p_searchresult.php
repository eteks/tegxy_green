...
//db connection
 ...
 /************************************************************************** PAGENATION START ************************************************************************************/
	...
	$status = mysql_select_db('tracemein2', $conn);
	if(!$status) die("Failed to select database!");
	$sql = 'SELECT * FROM  ".TABLE_REGISTRATION." WHERE  $searchsql RGT_Status=1 AND RGT_Type=2 $querycitymatch  $queryareamatch $industry_view';
...
echo $dispkeyword;?></span></span><?php } ?><?php */?>
