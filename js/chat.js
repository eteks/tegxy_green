...
//alert(chatname);
	...
	.addClass("chatbox")
	.html('<div ><div class="chatboxhead"><div class="chatboxtitle"><b>'+chatname+'</b></div><div class="chatboxoptions"><a href="javascript:void(0)" title="Minimize" style="font-size:22px;" onclick="javascript:toggleChatBoxGrowth(\''+chatboxtitle+'\')"><b>- </b></a><a title="Close" href="javascript:void(0)" onclick="javascript:closeChatBox(\''+chatboxtitle+'\')"> <b>X</b> </a></div><br clear="all"/></div></div><div class="chatboxcontent"></div><div class="chatboxinput"><textarea class="chatboxtextarea" onkeydown="javascript:return checkChatBoxInputKey(event,this,\''+chatboxtitle+'\',\''+chatname+'\');"></textarea></div>')
	.appendTo($( "body" ));
	//		   alert('sw');
      $("#chatbox_"+chatboxtitle).css('z-index', '99999999');
