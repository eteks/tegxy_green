...
<div class="heading" style="text-align:center">Best Deals</div>
<div id="personal" style="margin-left:50px; padding-bottom:30px;width:680px;">

<div id="ProductEntryLevel"  style="display:none;">

<div class="pagination handsym" onclick="GridShowHide('ProductEntryLevel','ProductEntryGrid','Grid','');" style="line-height: 49px;">
<img width="30" height="30" src="images/Back-icon.png" title="Back">
</div>

<div style="clear:both"></div>

<fieldset id="Fields">
<legend>Best Deals</legend>
...
<td>Display Name</td>
<td> :&nbsp;</td>
<td><input type="text" name="ProDisplayName" id="ProDisplayName"  autocomplete="off" class="inp-text" /></td>
</tr>
<tr><td colspan="3" height="10"></td></tr>
<tr>
...
<!--<input type="text" id="ProCategoryList" name="ProCategoryList" style="width:400px;" autocomplete="off" class="inp-text" placeholder="Please Select Industry" readonly="readonly"/>
<a class="ui-dropdown-trigger" id="ProCatList">&nbsp;</a><div id="ProCategoryResponse"></div>-->

<select name="ProCategoryList" id="ProCategoryList" onchange="setsessionvalue(this.value);" class="mselect">
...
<tr><td colspan="3" height="10"></td></tr>
<tr>
<td colspan="4"><table width="633" border="0" cellpadding="0" cellspacing="0">
  <tr>
    <td width="84">Quantity</td>
    <td width="9">:&nbsp;</td>
    <td width="88"><input type="text" id="Unit" name="Unit" onkeyup="Numbercharacteronly(this);" autocomplete="off" class="inp-text" style="width:55px;" /></td>
    <td width="14">&nbsp;</td>
    <td width="48">Price</td>
    <td width="54">:&nbsp;</td>
    <td width="55"><input type="text" id="Price" name="Price" onkeyup="Numberdot(this);" autocomplete="off" class="inp-text" style="width:55px;" /></td>
    <td width="8">&nbsp;</td>
    <td width="273">
	<select type="text" id="Currency" name="Currency" class="mselect" style="width:55px;">
...
<tr>
<td height="24">
<input type="button" name="SpProductSmt" Id="SpProductSmt" class="submit-btn" value="Add Specification"  onclick="AddSpProduct();"/>&nbsp;&nbsp;
</td>
<td>&nbsp;</td>
...
<td>
Inner Image
<br /><em><span class="alertmsg">Maximum limit of three images</span></em>
</td>
<td> :&nbsp;</td>
<td>

<span id="PGalleryUpload" style="cursor:pointer;">
<img src="images/upload-icon.png" />&nbsp;upload</span>

<span style="display:none;" id="PGalleryStatus"></span>

<span id="PGalleryList"></span><br/><em><span class="alertmsg">(gif,jpg,png Files Only - Below 1MB)</span></em>
</td>
</tr>
<tr><td colspan="3" height="10"></td></tr>
...
<td> :&nbsp;</td>
<td>
<input type="text" id="ProCountry" name="ProCountry"  autocomplete="off" class="inp-text" />
<div id="ProLocationResponse"></div>
<script type="text/javascript">
...
<tr>
<td colspan="3" align="center">
<input type="button" onclick="AddProduct();" id="ProductSmt" name="ProSmt" value="Add"  class="submit-btn" />&nbsp;&nbsp;&nbsp;
<input type="button" onclick="ProductReset();" value="Reset" class="submit-btn" />&nbsp;&nbsp;&nbsp;
...
<div id="ProductEntryGrid" style="display:block;">
<table border="0" cellspacing="0" cellpadding="0" width="100%" class="mfieldset">
<tr class="pagination heading2"><td width="90%" colspan="2">

<!--<span onclick="GridShowHide('ProductEntryLevel','ProductEntryGrid','Page','');ProductReset();"><b>Add New&nbsp;</b>
</span>-->

</td><td width="10%"><span class="handsym" onclick="GridShowHide('ProductEntryLevel','ProductEntryGrid','Page','');ProductReset();"><img src="images/Add.png" width="30" height="30" title="Add" /></span></td></tr>
<tr><td colspan="5" class="gridbgcolor" >
<div id="ProductGrid" class="gridpad">

<?php
$sqltot="SELECT PS_Id,PS_IndustryFk,PS_Display,PS_Fk,PS_CategoryFk,CASE WHEN PS_Mode =1 Then 'Provider' else 'Seeker' END PS_Mode  FROM ".TABLE_PRODUCTSERVICE." WHERE PS_User_Fk='".$UId."' order by  PS_Id desc";
$tot=db_query($sqltot);
...
if($Count>0){
$Pid=1;
//while(list($PS_Id,$PS_Display,$PS_IndustryFk,$PS_Fk ,$PS_CategoryFk,$PS_Mode) = db_fetch_array($SqlRun)){
while($Fetchspro=  db_fetch_array($SqlRun)){
?>

<tr class="gridcenbgcolor"  height="25">

<td width="5%"><?php  echo $Pid;?></td>
<td width="25%"><?php  echo $Fetchspro['PS_Display'];?></td>
<td width="25%">

<?php $indust =$Fetchspro['PS_IndustryFk'];  ?>

<?php 
$querysector=db_query("SELECT S_Name FROM  ".TABLE_SECTOR." WHERE  `Id` ='".$indust."'");
...
<td width="30%"><?php  echo $Fetchspro['PS_Mode'];?></td>

<td width="10%" class="handsym"><img width="16" border="0" height="16"  onclick="ProductEdit(<?php echo $PS_Id;?>);" src="images/b_edit.png" title="Edit">&nbsp;
<img width="16" border="0" height="16" src="images/b_drop.png" onclick="ProductDelete(<?php echo $PS_Id;?>,<?php echo $Count;?>,<?php echo $startdata;?>);"  title="Delete"></td>
</tr>
<?php  $Pid++;}?>
<tr><td colspan="5" class="gridlinebgcolor"></td></tr>
