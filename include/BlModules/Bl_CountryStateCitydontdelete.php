...
$SelectState=db_query("Select Id,St_Name From ".TABLE_GENERALSTATEMASTER." WHERE Status=1 AND St_Country='".$Country."' Order by Id asc"); 
...
$SelectArea=db_query("Select Id,Area From ".TABLE_GENERALAREAMASTER." WHERE Status=1 AND A_Country='".$Country."' Order by Id asc"); 
while(list($Id,$Area)=db_fetch_array($SelectArea))
{ ?>
<option  value="<?php echo $Id; ?>" ><?php echo $Area; ?></option><?php 
}?>
</select>######<select id="<?php echo $AreaName ;?>" name="<?php echo $AreaName ;?>" class="memberinput"  onchange="return OnclickAreaa(this.value,'<?php echo $CountName ;?>','<?php echo $StaName ;?>','<?php echo $CitName ;?>','<?php echo $AreaName ;?>','<?php echo $Pincode ;?>');">
<option value="" selected="selected">--Select Area--</option><?php 

$SelectArea=db_query("Select AM_Id, AM_Area From ".TABLE_AREAMASTER." WHERE AM_Status=1 AND AM_Country='".$Country."' Order by AM_Id asc"); 
while(list($Id,$Area)=db_fetch_array($SelectArea))
{ ?>
<option  value="<?php echo $Id; ?>" ><?php echo $Area; ?></option><?php 
}?>
...
$SelectPin=db_query("Select PM_Id, PM_Pincode From ".TABLE_PINCODEMASTER." WHERE PM_Status=1  AND PM_Country='".$Country."' Order by PM_Id asc"); ?>
<option value="" selected="selected">--Select Pincode--</option>
<?php while(list($Id,$Pin)=db_fetch_array($SelectPin))
{ ?>
...
if($State!='')
{ ?>
<select id="<?php echo $CitName ;?>" name="<?php echo $CitName ;?>" class="memberinput"  onchange="return OnclickCityy(this.value,'<?php echo $CountName ;?>','<?php echo $StaName ;?>','<?php echo $CitName ;?>','<?php echo $AreaName ;?>','<?php echo $Pincode ;?>');">
<option value="" selected="selected">--Select City--</option><?php 
...
$SelectArea=db_query("Select AM_Id, AM_Area From ".TABLE_AREAMASTER." WHERE AM_Status=1 AND AM_Country='".$Coun1."' AND AM_State='".$State."' Order by AM_Id asc"); 
while(list($Id,$Area)=db_fetch_array($SelectArea))
{ ?>
<option  value="<?php echo $Id; ?>" ><?php echo $Area; ?></option><?php 
}?>
...
$SelectPin=db_query("Select PM_Id, PM_Pincode From ".TABLE_PINCODEMASTER." WHERE PM_Status=1  AND PM_Country='".$Coun1."' AND PM_State='".$State."' Order by PM_Id asc"); ?>
<option value="" selected="selected">--Select Pincode--</option>
<?php while(list($Id,$Pin)=db_fetch_array($SelectPin))
{ ?>
<option  value="<?php echo $Id; ?>" ><?php echo $Pin; ?></option><?php 
...
{?>
<select id="<?php echo $CitName ;?>" name="<?php echo $CitName ;?>" class="memberinput"  >
</select>######<select id="<?php echo $AreaName ;?>" name="<?php echo $AreaName ;?>" class="memberinput" >
</select>######<select id="<?php echo $Pincode ;?>" name="<?php echo $Pincode ;?>" class="memberinput" >
</select><?php echo '######'.$CitName.'######'.$AreaName.'######'.$Pincode ; exit;
}}
...
if($City!='')
{ ?>
<select id="<?php echo $AreaName ;?>" name="<?php echo $AreaName ;?>" class="memberinput"  onchange="return OnclickAreaa(this.value,'<?php echo $CountName ;?>','<?php echo $StaName ;?>','<?php echo $CitName ;?>','<?php echo $AreaName ;?>','<?php echo $Pincode ;?>');">
<option value="" selected="selected">--Select Area--</option><?php 
...
$SelectPin=db_query("Select PM_Id, PM_Pincode From ".TABLE_PINCODEMASTER." WHERE PM_Status=1  AND PM_Country='".$Coun1."' AND PM_State='".$State1."' AND PM_City='".$City."' Order by PM_Id asc"); ?>
<option value="" selected="selected">--Select Pincode--</option>
<?php while(list($Id,$Pin)=db_fetch_array($SelectPin))
{ ?>
<option  value="<?php echo $Id; ?>" ><?php echo $Pin; ?></option><?php 
