<?php
 ...
 ?>
	<table width="100%" border="0" cellspacing="0" cellpadding="3" style="background:#fdf3de;">
          <tr>
                ...
                <td align="left" valign="top" class="td"><table width="100%" border="0" cellspacing="0" cellpadding="0">
                  ...
                  <tr>
                    ...
                    <table width="100%" border="0" cellspacing="0" cellpadding="0" style="background:#fdf3de;" >
                      ...
                      <tr id="tr_<?php echo $id ?>" <?php if ($id == $optId) echo 'style="font-weight:bold; color: orange;"'; 
						...
						<?php 
							if($CheckModulePrevilage[3]==1)
							{
								...
								{ 
									echo "<span  onclick=\"return OnClickNVerification('$id','$startdata')\" style=\"text-decoration:underline;cursor:pointer\">Verified</span>";
								}
								else
								{
									echo "<span  onclick=\"return OnClickVerification('$id','$startdata')\" style=\"text-decoration:underline;cursor:pointer\">Not Verified</span>";
								}  
							}
							?>
						</td>
                      ...
                      <tr><td colspan="7" align="center" class="gridtxt1" style="color:#333">No Record Found</td></tr>
                    <?php } ?>
                      <tr>
                        <td height="30" colspan="<?php echo $colspan;?>" align="right" style="padding:0 15px 0 0;">
                        <table border="0" cellspacing="0" cellpadding="0" style="color:#390;">
                      <tr>
